...
var WxCanvas = function () {
  ...
  WxCanvas.prototype.addEventListener = function addEventListener() {
    // ECharts 5 / ZRender may call the standard DOM event API.
    // WeChat Mini Program canvas events are bridged by ec-canvas touch handlers.
  };

  WxCanvas.prototype.removeEventListener = function removeEventListener() {
    // Keep parity with addEventListener for ZRender cleanup.
  };
