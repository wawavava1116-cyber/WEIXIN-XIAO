const team = {
  ...
  seed3ABCDF: { cn: '3ABCDF', en: '3ABCDF', flag: '' },
  seed3CDFGH: { cn: '3CDFGH', en: '3CDFGH', flag: '' },
  seed3BEFIJ: { cn: '3BEFIJ', en: '3BEFIJ', flag: '' },
  seed3AEHIJ: { cn: '3AEHIJ', en: '3AEHIJ', flag: '' },
  seed3CEFHI: { cn: '3CEFHI', en: '3CEFHI', flag: '' },
  seed3EHIJK: { cn: '3EHIJK', en: '3EHIJK', flag: '' },
  seed3EFGIJ: { cn: '3EFGIJ', en: '3EFGIJ', flag: '' },
  seed3DEIJL: { cn: '3DEIJL', en: '3DEIJL', flag: '' }
}
...
const teamProfile = {
  ...
  seed3ABCDF: { rank: 0, value: '待定' },
  seed3CDFGH: { rank: 0, value: '待定' },
  seed3BEFIJ: { rank: 0, value: '待定' },
  seed3AEHIJ: { rank: 0, value: '待定' },
  seed3CEFHI: { rank: 0, value: '待定' },
  seed3EHIJK: { rank: 0, value: '待定' },
  seed3EFGIJ: { rank: 0, value: '待定' },
  seed3DEIJL: { rank: 0, value: '待定' }
}
...
function makeRollingMatch({ id, group, venue, home, away, result, resultBackup = '', score, backup, total, order, homeForm, awayForm, homeNews, awayNews, tactics, risk, oneXtwo, handicap, marketTotal, knockoutRound = '' }) {
  return {
    id,
    dateText: '赛前更新',
    group,
...
matches.push(
  ...
  makeRollingMatch({
    ...
    risk: '沙特必须抢分会抬高开放度，但佛得角的防守纪律和反击空间更适合末轮偷胜。',
    oneXtwo: '佛得角胜主选，平局作为低比分保护',
    handicap: '佛得角受让方向优先，主胜是末轮战意和反击空间的大胆项',
    marketTotal: '2/2.25球，倾向低比分'
  }),
  makeRollingMatch({
    ...
    awayForm: '西班牙小组主动权更足，末轮可能更重视控球管理、轮换和避免消耗。',
    ...
    risk: '西班牙实力仍是上限最高的一方，但若轮换和控节奏，乌拉圭的抢分强度会把比赛拉向平局或小冷。',
    oneXtwo: '平局主选，乌拉圭胜作为战意和身体对抗的大胆备选',
    handicap: '乌拉圭受让方向优先，不追西班牙让步',
    marketTotal: '2.25/2.5球，偏2-3球'
  }),
  makeRollingMatch({
    ...
    backup: '1-3',
    total: '3-4球',
    order: '比利时胜 > 比利时必须提速 > 3-4球',
    homeForm: '新西兰身体对抗和高球威胁稳定，但面对比利时肋部推进时防线横移压力会更大。',
    awayForm: '比利时如果仍在第三名边缘，末轮必须主动提高射门量，Doku 和 De Bruyne 一侧会持续制造机会。',
    ...
    risk: '比利时防守转换仍有隐患，新西兰定位球有一球空间；但必须赢的战意会提高比利时进球上限。',
    oneXtwo: '比利时胜方向清晰，不设置胜平负备选',
    handicap: '比利时-1附近，赢球方向清晰，穿盘取决于早段进球',
    marketTotal: '2.5/3球，末轮战意上调到3-4球'
  }),
  makeRollingMatch({
  ...
  makeRollingMatch({
    ...
    awayForm: '瑞典落后一线，末轮必须把高点、定位球和二次进攻全部打出来，战意比常规模型更强。',
    ...
    risk: '日本控球稳定，若瑞典久攻不下会被反击惩罚；但瑞典必须赢的局面让高球和定位球权重上升。',
    oneXtwo: '瑞典胜主选，平局作为日本控球韧性的保护',
    handicap: '瑞典-0.25谨慎，强在战意和定位球，不追深盘',
    marketTotal: '2.25/2.5球，倾向2-3球'
  }),
  makeRollingMatch({
  ...
  makeRollingMatch({
    ...
    backup: '1-1',
    total: '2-3球',
    order: '土耳其胜 > 平局保护 > 2-3球',
    homeForm: '土耳其创造力强，但首轮防守转换暴露问题，面对美国速度和压迫会继续承压。',
    awayForm: '美国已经提前出线，主场环境仍在，但轮换和避免伤病的优先级会明显提高。',
    ...
    risk: '这是末轮大胆项：美国整体实力仍更强，但已出线轮换叠加土耳其搏命，冷门和打平概率都被上调。',
    oneXtwo: '土耳其胜主选，平局作为美国轮换后控节奏的保护',
    handicap: '土耳其受让方向优先，主胜是战意和轮换折扣下的大胆项',
    marketTotal: '2.5球附近，倾向2-3球'
  }),
  makeRollingMatch({
  ...
  makeRollingMatch({
    ...
    awayForm: '法国整体实力仍高，但若已占据出线主动，轮换和保护核心会让压迫连续性下降。',
    ...
    risk: '这是强队轮换下的大胆项；法国个人能力足以随时改写比赛，但挪威战意和锋线冲击值得上调。',
    oneXtwo: '挪威胜主选，平局作为双方已掌握出线主动后的保护',
    handicap: '挪威受让方向优先，主胜看定位球和转换效率',
    marketTotal: '2.5球附近，倾向2-3球'
  }),
  makeRollingMatch({
  ...
  makeRollingMatch({
    ...
    awayForm: '葡萄牙已经打出大胜势头，阵容深度好，但末轮保护核心和轮换的概率更高。',
    ...
    risk: '葡萄牙技术上限仍高，但若已提前占优，哥伦比亚的对抗、速度和必须拿分动机会制造小冷。',
    oneXtwo: '哥伦比亚胜主选，平局作为葡萄牙控节奏保护',
    handicap: '哥伦比亚受让方向优先，主胜是末轮战意大胆项',
    marketTotal: '2.5球附近，倾向2-3球'
  }),
  makeRollingMatch({
...
matches.push(
  makeRollingMatch({
    id: 'southafrica-bosnia-20260629',
    group: '1/16决赛',
    knockoutRound: '32强',
    venue: 'Los Angeles Stadium',
    home: 'southAfrica',
    ...
    total: '2-3球',
    order: '平局 > 波黑胜保护 > 2-3球',
    homeForm: '南非小组赛后段防守强度提升，反击和定位球效率不错，但进入淘汰赛后控球稳定性仍是短板。',
    awayForm: '波黑中前场对抗和禁区终结更成熟，若能把比赛拖入阵地战，后程冲击力会更好。',
    homeNews: '南非需要确认主力中卫和边翼卫体能，淘汰赛首战不会轻易压上。',
    awayNews: '波黑阵容完整度优先核对中锋和后腰，若两条中轴都可首发，客胜权重上调。',
    tactics: '南非更可能先稳低位，波黑依靠中路支点和边路传中制造机会，比赛有加时风险。',
    risk: '两队实力差距不大，早段进球会明显改变节奏；若南非定位球先进，波黑深追风险增大。',
    oneXtwo: '平局主选，波黑胜作为备选',
    handicap: '波黑平手到-0.25谨慎，常规时间防平',
    marketTotal: '2/2.25球，倾向2-3球'
  }),
  makeRollingMatch({
    id: 'brazil-japan-20260630',
    group: '1/16决赛',
    knockoutRound: '32强',
    venue: 'Houston Stadium',
    home: 'brazil',
    ...
    backup: '2-0',
    total: '2-3球',
    order: '巴西胜 > 巴西-0.75谨慎 > 2-3球',
    homeForm: '巴西小组赛攻防稳定，前场个人能力和转换速度仍是淘汰赛优势。',
    awayForm: '日本压迫和传控质量高，能给巴西后腰区域制造压力，但禁区对抗和防定位球会吃亏。',
    homeNews: '巴西重点确认边锋和中卫健康，若首发完整，主胜方向清晰。',
    awayNews: '日本需要核对主力后腰与边后卫体能，若轮换深度不足，后程防守压力上升。',
    tactics: '巴西用边路单点和前场反抢抢开局，日本会尝试控球降速，比赛更像巴西小胜。',
    risk: '日本若控球成功，巴西穿盘难度增加；若巴西早进球，2-0空间打开。',
    oneXtwo: '巴西胜方向清晰，不设置胜平负备选',
    handicap: '巴西-0.75到-1，赢球优先，穿盘看早段效率',
    marketTotal: '2.5球附近，倾向2-3球'
  }),
  makeRollingMatch({
    id: 'germany-seed3abcdf-20260630',
    group: '1/16决赛',
    knockoutRound: '32强',
    venue: 'Boston Stadium',
    home: 'germany',
    ...
    backup: '2-1',
    total: '2-3球',
    order: '德国胜 > 德国-1谨慎 > 2-3球',
    homeForm: '德国小组赛整体压制力仍强，淘汰赛首战会更重视防守平衡。',
    awayForm: '第三名席位尚按规则池待最终映射，整体会以低位防守和反击为主。',
    homeNews: '德国需确认中卫组合和中锋首发，若主力完整，常规时间晋级概率高。',
    awayNews: '第三名球队身份待赛程源最终落位，赛前需补充具体伤停。',
    tactics: '德国控球压迫，重点打肋部和二点球，预计不会无脑拉开大比分。',
    risk: '第三名球队若防守纪律强，德国穿深盘风险高；球队身份落位后需复核。',
    oneXtwo: '德国胜方向清晰，不设置胜平负备选',
    handicap: '德国-1附近可看，深盘谨慎',
    marketTotal: '2.5球，倾向2-3球'
  }),
  makeRollingMatch({
    id: 'netherlands-morocco-20260630',
    group: '1/16决赛',
    knockoutRound: '32强',
    venue: 'Philadelphia Stadium',
    home: 'netherlands',
    ...
    total: '2-3球',
    order: '荷兰胜 > 平局保护 > 2-3球',
    homeForm: '荷兰小组赛进攻端打开后，边翼卫和中路插上形成稳定压迫。',
    awayForm: '摩洛哥防守纪律和反击质量都很高，淘汰赛会把比赛压成一球差。',
    homeNews: '荷兰需要确认中卫和边翼卫体能，若首发稳定，主胜更稳。',
    awayNews: '摩洛哥边路核心和后腰健康度关键，若防守主力完整，平局权重上升。',
    tactics: '荷兰主动控球，摩洛哥抓转换和定位球，比赛不会轻松拉开。',
    risk: '摩洛哥反击效率、荷兰后场出球失误、裁判尺度都会影响胜平方向。',
    oneXtwo: '荷兰胜主选，平局作低权重保护',
    handicap: '荷兰-0.25到-0.5，赢球优先，不追深',
    marketTotal: '2.25/2.5球，倾向2-3球'
  }),
  makeRollingMatch({
    id: 'france-seed3cdfgh-20260701',
    group: '1/16决赛',
    knockoutRound: '32强',
    venue: 'New York New Jersey Stadium',
    home: 'france',
    ...
    backup: '2-1',
    total: '2-3球',
    order: '法国胜 > 法国-1谨慎 > 2-3球',
    homeForm: '法国小组赛攻守效率稳定，转换速度和个人能力在32强阶段仍有明显上限。',
    awayForm: '第三名对手待映射，通常会以低位压缩空间，依赖反击和定位球。',
    homeNews: '法国需核对核心边锋与中卫健康，若完整首发，主胜方向清晰。',
    awayNews: '对手身份落位后需补充停赛和伤病，尤其是门将和中卫。',
    tactics: '法国会先控风险再提速，重点通过边路和二线插上制造一球领先。',
    risk: '若第三名球队防守密度高，法国可能赢球不穿；身份未定降低比分确定性。',
    oneXtwo: '法国胜方向清晰，不设置胜平负备选',
    handicap: '法国-1附近，深盘谨慎',
    marketTotal: '2.5球，倾向2-3球'
  }),
  makeRollingMatch({
    id: 'ivorycoast-norway-20260701',
    group: '1/16决赛',
    knockoutRound: '32强',
    venue: 'Miami Stadium',
    home: 'ivoryCoast',
    ...
    total: '2-3球',
    order: '挪威胜 > 平局保护 > 2-3球',
    homeForm: '科特迪瓦身体对抗和边路推进强，但防线在高压下偶有空当。',
    awayForm: '挪威锋线终结和高点优势明显，淘汰赛若拿到定位球会很有威胁。',
    homeNews: '科特迪瓦需要确认中卫和后腰黄牌、体能，若防线不整，丢第二球风险大。',
    awayNews: '挪威重点核对主力中锋和边路传中点，核心出战则客胜权重提高。',
    tactics: '科特迪瓦会提高对抗，挪威利用高点、二点球和快速直塞压制禁区。',
    risk: '迈阿密天气和对抗强度会放大体能波动；若挪威早段效率低，平局风险上升。',
    oneXtwo: '挪威胜主选，平局作低权重保护',
    handicap: '挪威平手到-0.25，防一球差和加时',
    marketTotal: '2.25/2.5球，倾向2-3球'
  }),
  makeRollingMatch({
    id: 'mexico-seed3cefhi-20260701',
    group: '1/16决赛',
    knockoutRound: '32强',
    venue: 'Atlanta Stadium',
    home: 'mexico',
    ...
    backup: '2-1',
    total: '2-3球',
    order: '墨西哥胜 > 墨西哥-0.75谨慎 > 2-3球',
    homeForm: '墨西哥已经锁定A组第一，防守稳定性和主场氛围是淘汰赛优势。',
    awayForm: '第三名席位待最终映射，整体会先压低阵型争取拖入后程。',
    homeNews: '墨西哥需确认边锋和后腰体能，若主力完整，常规时间优势明显。',
    awayNews: '对手身份落位后需重点补充停赛和门将状态。',
    tactics: '墨西哥通过边路压迫和前场反抢制造连续进攻，预计先稳再寻找第二球。',
    risk: '若对手低位防守质量高，墨西哥穿盘不稳；身份未定需赛前复核。',
    oneXtwo: '墨西哥胜方向清晰，不设置胜平负备选',
    handicap: '墨西哥-0.75附近，赢球优先',
    marketTotal: '2.25/2.5球，倾向2-3球'
  }),
  makeRollingMatch({
    id: 'england-seed3ehijk-20260702',
    group: '1/16决赛',
    knockoutRound: '32强',
    venue: 'BC Place Vancouver',
    home: 'england',
    ...
    total: '2-3球',
    order: '英格兰胜 > 英格兰-1谨慎 > 2-3球',
    homeForm: '英格兰最后一轮赢球后进入淘汰赛，阵容深度和防守控制力仍是强项。',
    awayForm: '第三名对手待规则映射，通常会更重视密集防守和反击。',
    homeNews: '英格兰需确认锋线轮换和中卫搭档，若主力回归，常规时间胜面高。',
    awayNews: '对手身份落位后再复核停赛，尤其是防线主力是否可用。',
    tactics: '英格兰会通过边路宽度和定位球压制，领先后更偏比赛管理。',
    risk: '英格兰若慢热，深盘穿透不稳；对手身份未定降低比分置信度。',
    oneXtwo: '英格兰胜方向清晰，不设置胜平负备选',
    handicap: '英格兰-1附近，赢球优先，穿盘谨慎',
    marketTotal: '2.5球，倾向2-3球'
  }),
  makeRollingMatch({
    id: 'usa-seed3befij-20260702',
    group: '1/16决赛',
    knockoutRound: '32强',
    venue: 'Kansas City Stadium',
    home: 'usa',
    ...
    backup: '1-0',
    total: '1-2球',
    order: '美国胜 > 美国-0.5谨慎 > 1-2球',
    homeForm: '美国已确定D组第一，速度、前场压迫和主场环境优势明显。',
    awayForm: '第三名席位待映射，对手大概率会先稳守，比赛初段不会轻易开放。',
    homeNews: '美国需确认中场屏障和主力边锋状态，若体能恢复好，主胜权重稳定。',
    awayNews: '对手身份落位后需补充具体伤停和黄牌停赛。',
    tactics: '美国会用速度和压迫抢开局，但淘汰赛会控制后场风险。',
    risk: '若美国把握机会效率一般，一球小胜概率高；第三名身份未定需复核。',
    oneXtwo: '美国胜方向清晰，不设置胜平负备选',
    handicap: '美国-0.5到-0.75，赢球优先，不追深',
    marketTotal: '2/2.25球，倾向1-2球'
  }),
  makeRollingMatch({
    id: 'belgium-seed3aehij-20260702',
    group: '1/16决赛',
    knockoutRound: '32强',
    venue: 'Houston Stadium',
    home: 'belgium',
    ...
    homeForm: '比利时小组赛后段进攻状态回升，面对第三名球队具备控场优势。',
    awayForm: '第三名对手待映射，淘汰赛会优先压低阵型和降低节奏。',
    homeNews: '比利时需确认中前场核心体能，若首发稳定，主胜更清晰。',
    awayNews: '对手身份落位后重点复核防线停赛和门将状态。',
    tactics: '比利时控球推进，利用肋部和中锋支点制造机会，预计常规时间占优。',
    risk: '比利时若转换速度慢，比赛可能变成低比分；身份未定需赛前复核。',
    oneXtwo: '比利时胜方向清晰，不设置胜平负备选',
    handicap: '比利时-0.75附近，赢球优先',
    marketTotal: '2.25/2.5球，倾向2-3球'
  }),
  makeRollingMatch({
    id: 'switzerland-seed3efgij-20260703',
    group: '1/16决赛',
    knockoutRound: '32强',
    venue: 'BC Place Vancouver',
    home: 'switzerland',
    ...
    total: '2-3球',
    order: '瑞士胜 > 平局保护 > 2-3球',
    homeForm: '瑞士小组赛稳定性强，淘汰赛的组织纪律和定位球质量值得高看。',
    awayForm: '第三名对手待映射，若身体对抗强，瑞士会面临一球差压力。',
    homeNews: '瑞士重点确认中卫和门将状态，阵容完整时常规时间优势更稳。',
    awayNews: '对手身份落位后需补充具体伤停。',
    tactics: '瑞士用阵地推进和定位球抢优势，对手以反击争取拖入加时。',
    risk: '瑞士进攻上限不算夸张，若久攻不下，平局保护必要。',
    oneXtwo: '瑞士胜主选，平局作低权重保护',
    handicap: '瑞士-0.25到-0.5，不追深',
    marketTotal: '2/2.25球，倾向2-3球'
  }),
  makeRollingMatch({
    id: 'spain-austria-20260703',
    group: '1/16决赛',
    knockoutRound: '32强',
    venue: 'Seattle Stadium',
    home: 'spain',
    ...
    backup: '2-1',
    total: '2-3球',
    order: '西班牙胜 > 西班牙-1谨慎 > 2-3球',
    homeForm: '西班牙小组赛零封能力突出，控球和反抢会限制奥地利推进。',
    awayForm: '奥地利最后一轮打出高比分平局，进攻有韧性，但防线空间暴露明显。',
    homeNews: '西班牙需确认中场核心轮换和边锋体能，主力完整时压制力很强。',
    awayNews: '奥地利要核对中卫和后腰体能，连续高强度比赛后防守质量是隐患。',
    tactics: '西班牙控球压制，奥地利通过高压和二点球寻找反击，节奏可能先紧后开。',
    risk: '若西班牙早段无法破门，深盘穿透会下降；奥地利定位球有制造失球风险。',
    oneXtwo: '西班牙胜方向清晰，不设置胜平负备选',
    handicap: '西班牙-1附近，赢球优先，穿盘谨慎',
    marketTotal: '2.25/2.5球，倾向2-3球'
  }),
  makeRollingMatch({
    id: 'portugal-croatia-20260703',
    group: '1/16决赛',
    knockoutRound: '32强',
    venue: 'Toronto Stadium',
    home: 'portugal',
    ...
    homeForm: '葡萄牙小组赛末轮被逼平后，淘汰赛会更重视进攻效率和防守平衡。',
    awayForm: '克罗地亚经验和中场控节奏能力强，末轮赢球后士气回升。',
    homeNews: '葡萄牙需确认锋线核心和边后卫体能，若主力完整，常规时间小胜权重较高。',
    awayNews: '克罗地亚老将体能和中卫健康是关键，若阵容齐整，平局概率不低。',
    tactics: '葡萄牙控球和边路冲击，克罗地亚用中场降速和定位球回应。',
    risk: '克罗地亚淘汰赛经验强，葡萄牙若过早压上会给反击空间。',
    oneXtwo: '葡萄牙胜主选，平局作低权重保护',
    handicap: '葡萄牙-0.25到-0.5，赢球优先，不追深',
    marketTotal: '2.25/2.5球，倾向2-3球'
  }),
  makeRollingMatch({
    id: 'australia-egypt-20260704',
    group: '1/16决赛',
    knockoutRound: '32强',
    venue: 'Kansas City Stadium',
    home: 'australia',
    ...
    total: '2-3球',
    order: '平局 > 埃及胜保护 > 2-3球',
    homeForm: '澳大利亚防守和高点稳定，淘汰赛会先把比赛拖入身体对抗。',
    awayForm: '埃及小组赛保持不败，前场个人能力和转换速度比澳大利亚更有上限。',
    homeNews: '澳大利亚需要确认中锋和中卫健康，若高点不齐，反击质量会下降。',
    awayNews: '埃及需确认锋线核心体能，若主力完整，常规时间偷胜机会更高。',
    tactics: '澳大利亚长传和定位球，埃及快速转换和边路一对一，比赛有加时味道。',
    risk: '澳大利亚定位球威胁、埃及转换效率、裁判对身体对抗尺度都会左右结果。',
    oneXtwo: '平局主选，埃及胜作为备选',
    handicap: '埃及平手到-0.25谨慎，常规时间防平',
    marketTotal: '2/2.25球，倾向2-3球'
  }),
  makeRollingMatch({
    id: 'argentina-caboverde-20260704',
    group: '1/16决赛',
    knockoutRound: '32强',
    venue: 'Dallas Stadium',
    home: 'argentina',
    ...
    backup: '3-0',
    total: '2-3球',
    order: '阿根廷胜 > 阿根廷-1.25谨慎 > 2-3球',
    homeForm: '阿根廷小组赛全胜，控球、压迫和终结稳定性都是32强优势。',
    awayForm: '佛得角防守韧性好，但连续硬仗后面对阿根廷的控球压迫会很吃力。',
    homeNews: '阿根廷需确认核心前场轮换，若首发完整，主胜方向清晰。',
    awayNews: '佛得角中卫和门将状态关键，若早段失球，比赛会明显被拉开。',
    tactics: '阿根廷控制中路和肋部，佛得角低位密集防守等待定位球。',
    risk: '阿根廷若领先后降速，深盘穿透不稳；佛得角防守质量会压低比分上限。',
    oneXtwo: '阿根廷胜方向清晰，不设置胜平负备选',
    handicap: '阿根廷-1到-1.25，赢球优先，穿盘谨慎',
    marketTotal: '2.5球，倾向2-3球'
  }),
  makeRollingMatch({
    id: 'colombia-seed3deijl-20260704',
    group: '1/16决赛',
    knockoutRound: '32强',
    venue: 'Los Angeles Stadium',
    home: 'colombia',
    ...
    total: '2-3球',
    order: '哥伦比亚胜 > 平局保护 > 2-3球',
    homeForm: '哥伦比亚小组赛防守稳定，身体对抗和前场冲击在淘汰赛具备优势。',
    awayForm: '第三名对手待映射，若来自强组，常规时间会制造很大防守压力。',
    homeNews: '哥伦比亚需确认前腰和边锋状态，若进攻核心完整，小胜权重更高。',
    awayNews: '对手身份落位后需补充停赛、伤病和门将状态。',
    tactics: '哥伦比亚通过前场压迫和边路冲击抢主动，对手大概率低位等反击。',
    risk: '第三名身份未定，若对手是欧洲强队，平局概率会提高。',
    oneXtwo: '哥伦比亚胜主选，平局作低权重保护',
    handicap: '哥伦比亚-0.25到-0.5，不追深',
    marketTotal: '2.25/2.5球，倾向2-3球'
  })
)
...
const matchMeta = {
  ...
  'southafrica-bosnia-20260629': { dateText: '6月29日 周一', kickoff: '03:00', scheduleAt: '2026-06-29T03:00:00+08:00', weatherIcon: '☀️', weather: '24℃' },
  'brazil-japan-20260630': { dateText: '6月30日 周二', kickoff: '01:00', scheduleAt: '2026-06-30T01:00:00+08:00', weatherIcon: '☀️', weather: '32℃' },
  'germany-seed3abcdf-20260630': { dateText: '6月30日 周二', kickoff: '04:30', scheduleAt: '2026-06-30T04:30:00+08:00', weatherIcon: '☁️', weather: '22℃' },
  'netherlands-morocco-20260630': { dateText: '6月30日 周二', kickoff: '09:00', scheduleAt: '2026-06-30T09:00:00+08:00', weatherIcon: '☁️', weather: '25℃' },
  'ivorycoast-norway-20260701': { dateText: '7月1日 周三', kickoff: '01:00', scheduleAt: '2026-07-01T01:00:00+08:00', weatherIcon: '☀️', weather: '30℃' },
  'france-seed3cdfgh-20260701': { dateText: '7月1日 周三', kickoff: '05:00', scheduleAt: '2026-07-01T05:00:00+08:00', weatherIcon: '☀️', weather: '25℃' },
  'mexico-seed3cefhi-20260701': { dateText: '7月1日 周三', kickoff: '09:00', scheduleAt: '2026-07-01T09:00:00+08:00', weatherIcon: '☁️', weather: '27℃' },
  'england-seed3ehijk-20260702': { dateText: '7月2日 周四', kickoff: '00:00', scheduleAt: '2026-07-02T00:00:00+08:00', weatherIcon: '☁️', weather: '19℃' },
  'belgium-seed3aehij-20260702': { dateText: '7月2日 周四', kickoff: '04:00', scheduleAt: '2026-07-02T04:00:00+08:00', weatherIcon: '☀️', weather: '32℃' },
  'usa-seed3befij-20260702': { dateText: '7月2日 周四', kickoff: '08:00', scheduleAt: '2026-07-02T08:00:00+08:00', weatherIcon: '☀️', weather: '29℃' },
  'switzerland-seed3efgij-20260703': { dateText: '7月3日 周五', kickoff: '00:00', scheduleAt: '2026-07-03T00:00:00+08:00', weatherIcon: '☁️', weather: '18℃' },
  'spain-austria-20260703': { dateText: '7月3日 周五', kickoff: '03:00', scheduleAt: '2026-07-03T03:00:00+08:00', weatherIcon: '☁️', weather: '19℃' },
  'portugal-croatia-20260703': { dateText: '7月3日 周五', kickoff: '07:00', scheduleAt: '2026-07-03T07:00:00+08:00', weatherIcon: '☁️', weather: '21℃' },
  'australia-egypt-20260704': { dateText: '7月4日 周六', kickoff: '02:00', scheduleAt: '2026-07-04T02:00:00+08:00', weatherIcon: '☀️', weather: '30℃' },
  'argentina-caboverde-20260704': { dateText: '7月4日 周六', kickoff: '06:00', scheduleAt: '2026-07-04T06:00:00+08:00', weatherIcon: '☀️', weather: '31℃' },
...
const betfairMarketSnapshot = {
  'usa-australia-20260619': { marketId: '1.251401910', totalMatched: 1305025, delayed: true, odds: { home: 1.65, draw: 4.6, away: 5.7 }, probability: { home: 61, draw: 22, away: 18 } },
  'scotland-morocco-20260619': { marketId: '1.258058492', totalMatched: 347156, delayed: true, odds: { home: 5.9, draw: 3.7, away: 1.79 }, probability: { home: 17, draw: 27, away: 56 } },
  'brazil-haiti-20260619': { marketId: '1.258055706', totalMatched: 288884, delayed: true, odds: { home: 1.12, draw: 12.5, away: 30 }, probability: { home: 89, draw: 8, away: 3 } },
  'turkey-paraguay-20260619': { marketId: '1.258055656', totalMatched: 173758, delayed: true, odds: { home: 2.14, draw: 3.5, away: 4.1 }, probability: { home: 47, draw: 29, away: 25 } },
  'netherlands-sweden-20260620': { marketId: '1.257505065', totalMatched: 236624, delayed: true, odds: { home: 1.77, draw: 4.2, away: 5 }, probability: { home: 56, draw: 24, away: 20 } },
  'ecuador-curacao-20260620': { marketId: '1.257505345', totalMatched: 319672, delayed: true, odds: { home: 1.16, draw: 10, away: 26 }, probability: { home: 86, draw: 10, away: 4 } },
  'tunisia-japan-20260620': { marketId: '1.257505483', totalMatched: 184527, delayed: true, odds: { home: 7, draw: 4.1, away: 1.63 }, probability: { home: 14, draw: 24, away: 61 } },
  'spain-saudi-20260621': { marketId: '1.257505885', totalMatched: 1937364, delayed: true, odds: { home: 1.13, draw: 13, away: 29 }, probability: { home: 89, draw: 8, away: 4 } },
  'belgium-iran-20260621': { marketId: '1.258433364', totalMatched: 698061, delayed: true, odds: { home: 1.45, draw: 5.2, away: 8.6 }, probability: { home: 69, draw: 19, away: 12 } },
  'uruguay-caboverde-20260621': { marketId: '1.257506024', totalMatched: 881728, delayed: true, odds: { home: 1.49, draw: 4.5, away: 10 }, probability: { home: 68, draw: 22, away: 10 } },
  'newzealand-egypt-20260621': { marketId: '1.257504035', totalMatched: 327152, delayed: true, odds: { home: 6.6, draw: 4.3, away: 1.64 }, probability: { home: 15, draw: 23, away: 61 } },
  'argentina-austria-20260622': { marketId: '1.257506162', totalMatched: 1943064, delayed: true, odds: { home: 1.49, draw: 4.6, away: 8.8 }, probability: { home: 67, draw: 22, away: 11 }, oddsMovement: { draw: 'steam', away: 'drift' } },
  'france-iraq-20260622': { marketId: '1.258432180', totalMatched: 449222, delayed: true, odds: { home: 1.11, draw: 14.5, away: 40 }, probability: { home: 91, draw: 7, away: 3 }, oddsMovement: { home: 'drift', away: 'steam' } },
  'norway-senegal-20260622': { marketId: '1.257506304', totalMatched: 677068, delayed: true, odds: { home: 2.28, draw: 3.65, away: 3.5 }, probability: { home: 44, draw: 27, away: 29 }, oddsMovement: { draw: 'drift' } },
  'jordan-algeria-20260622': { marketId: '1.257506467', totalMatched: 337949, delayed: true, odds: { home: 6.8, draw: 4.7, away: 1.57 }, probability: { home: 15, draw: 21, away: 64 }, oddsMovement: { home: 'steam', away: 'drift' } },
  'portugal-uzbekistan-20260623': { marketId: '1.258056400', totalMatched: 1094951, delayed: true, odds: { home: 1.17, draw: 9.4, away: 24 }, probability: { home: 85, draw: 11, away: 4 }, oddsMovement: { home: 'steam', draw: 'drift', away: 'drift' } },
  'england-ghana-20260623': { marketId: '1.257506605', totalMatched: 584090, delayed: true, odds: { home: 1.22, draw: 8, away: 20 }, probability: { home: 82, draw: 13, away: 5 }, oddsMovement: { home: 'steam', draw: 'drift', away: 'drift' } },
  'panama-croatia-20260623': { marketId: '1.257506750', totalMatched: 339581, delayed: true, odds: { home: 7.8, draw: 4.7, away: 1.53 }, probability: { home: 13, draw: 21, away: 66 }, oddsMovement: { home: 'drift', draw: 'drift', away: 'steam' } },
  'switzerland-canada-20260624': { marketId: '1.258370047', totalMatched: 150040, delayed: true, odds: { home: 2.46, draw: 3.25, away: 3.6 }, probability: { home: 41, draw: 31, away: 28 }, oddsMovement: { home: 'steam', draw: 'drift', away: 'drift' } },
  'scotland-brazil-20260624': { marketId: '1.258369771', totalMatched: 80902, delayed: true, odds: { home: 9.4, draw: 5.5, away: 1.4 }, probability: { home: 11, draw: 18, away: 71 } },
  'morocco-haiti-20260624': { marketId: '1.258422667', totalMatched: 68906, delayed: true, odds: { home: 1.2, draw: 8.2, away: 20 }, probability: { home: 83, draw: 12, away: 5 }, oddsMovement: { home: 'steam', draw: 'drift' } },
  'czechia-mexico-20260624': { marketId: '1.258427197', totalMatched: 344290, delayed: true, odds: { home: 3.95, draw: 4.1, away: 2 }, probability: { home: 25, draw: 25, away: 50 }, oddsMovement: { home: 'drift', draw: 'steam', away: 'drift' } },
  'ecuador-germany-20260625': { marketId: '1.258423084', totalMatched: 224914, delayed: true, odds: { home: 3.95, draw: 4.2, away: 1.97 }, probability: { home: 25, draw: 24, away: 51 }, oddsMovement: { home: 'drift', away: 'steam' } },
...
const predictionDiscipline = {
  ...
  'portugal-uzbekistan-20260623': { result: '葡萄牙胜', resultBackup: '', score: '3-0', backup: '2-0', total: '2-3球', oneXtwo: '葡萄牙胜方向清晰，不设置胜平负备选；必发胜/平/负约85/11/4，成交量约1095K，主胜成交大幅上涨且赔率从1.18压到1.17，强队预期上调', handicap: '参考葡萄牙-1.25；成交上涨同时主胜赔率下跌，支持葡萄牙赢球和两球附近优势，但深盘仍看首发强度与早段进球', order: '葡萄牙胜 > 葡萄牙-1.25谨慎 > 2-3球' },
  'england-ghana-20260623': { result: '英格兰胜', resultBackup: '', score: '2-0', backup: '2-1', total: '2-3球', oneXtwo: '英格兰胜方向清晰，不设置胜平负备选；必发胜/平/负约82/13/5，成交量约584K，主胜成交放大且赔率从1.24降到1.22，平局保护权重下调', handicap: '参考英格兰-1；成交上涨同时主胜赔率下跌，赢球预期增强，但加纳速度和定位球仍给一球空间', order: '英格兰胜 > 英格兰-1谨慎 > 2-3球' },
  'panama-croatia-20260623': { result: '克罗地亚胜', resultBackup: '', score: '0-2', backup: '1-2', total: '2-3球', oneXtwo: '克罗地亚胜方向清晰，不设置胜平负备选；必发胜/平/负约13/21/65，成交量约340K，客胜成交上涨且赔率从1.55压到1.53，反弹方向更稳', handicap: '参考克罗地亚-0.75到-1；成交和赔率同向支持客胜，但巴拿马定位球会限制深盘放大', order: '克罗地亚胜 > 克罗地亚-0.75/-1谨慎 > 2-3球' },
  ...
  'ecuador-germany-20260625': { result: '德国胜', resultBackup: '', score: '1-2', backup: '0-2', total: '2-3球', oneXtwo: '德国胜方向清晰，不设置胜平负备选；必发胜/平/负约25/24/51，成交量约225K，客胜赔率从2.00附近压到1.97，德国方向小幅增强', handicap: '参考德国-0.5到-0.75；德国赢球优先，穿盘看前场轮换与厄瓜多尔反击效率', order: '德国胜 > 德国-0.5/-0.75谨慎 > 2-3球' },
  ...
  'japan-sweden-20260625': { result: '瑞典胜', resultBackup: '平局', score: '1-2', backup: '1-1', total: '2-3球', oneXtwo: '瑞典胜主选，平局作为日本控球韧性的保护；瑞典末轮必须把高点、定位球和二次进攻打出来，战意权重上调', handicap: '参考瑞典-0.25谨慎；强在战意和定位球，不追深盘', order: '瑞典胜 > 平局保护 > 2-3球' },
  ...
  'turkey-usa-20260625': { result: '土耳其胜', resultBackup: '平局', score: '2-1', backup: '1-1', total: '2-3球', oneXtwo: '土耳其胜主选，平局作为美国轮换后控节奏的保护；美国已提前出线，土耳其搏命权重上调', handicap: '土耳其受让方向优先，主胜是战意和轮换折扣下的大胆项', order: '土耳其胜 > 平局保护 > 2-3球' },
  'paraguay-australia-20260625': { result: '平局', resultBackup: '巴拉圭胜', score: '1-1', backup: '1-0', total: '1-2球', oneXtwo: '平局主选，巴拉圭胜低权重备选；必发胜/平/负约33/43/24，成交量约330K，平局赔率维持低位，出线压力使比赛更像低比分拉锯', handicap: '参考澳大利亚0到+0.25谨慎；澳大利亚至少要抢分，巴拉圭防守韧性强，低比分优先', order: '平局 > 巴拉圭胜 > 1-2球' },
  'norway-france-20260626': { result: '挪威胜', resultBackup: '平局', score: '2-1', backup: '1-1', total: '2-3球', oneXtwo: '挪威胜主选，平局作为双方已掌握出线主动后的保护；法国定价占优但轮换折扣和挪威锋线冲击被上调', handicap: '挪威受让方向优先，主胜看定位球和转换效率', order: '挪威胜 > 平局保护 > 2-3球' },
  'senegal-iraq-20260626': { result: '塞内加尔胜', resultBackup: '', score: '2-0', backup: '2-1', total: '2-3球', oneXtwo: '塞内加尔胜方向清晰，不设置胜平负备选；必发胜/平/负约78/14/7，成交量约17K，强弱方向清楚但成交量仍偏早', handicap: '参考塞内加尔-1；塞内加尔需要争取排名，赢球优先，穿盘看早段压制', order: '塞内加尔胜 > 塞内加尔-1谨慎 > 2-3球' },
  'caboverde-saudi-20260626': { result: '佛得角胜', resultBackup: '平局', score: '1-0', backup: '1-1', total: '1-2球', oneXtwo: '佛得角胜主选，平局作为低比分保护；沙特必须抢分会抬高开放度，但佛得角防守纪律和反击空间更适合末轮偷胜', handicap: '佛得角受让方向优先，主胜是末轮战意和反击空间的大胆项', order: '佛得角胜 > 平局保护 > 1-2球' },
  'uruguay-spain-20260626': { result: '平局', resultBackup: '乌拉圭胜', score: '1-1', backup: '2-1', total: '2-3球', oneXtwo: '平局主选，乌拉圭胜作为战意和身体对抗的大胆备选；西班牙实力仍高，但末轮控节奏和轮换会抬高乌拉圭抢分权重', handicap: '乌拉圭受让方向优先，不追西班牙让步', order: '平局 > 乌拉圭胜 > 2-3球' },
  'newzealand-belgium-20260626': { result: '比利时胜', resultBackup: '', score: '0-3', backup: '1-3', total: '3-4球', oneXtwo: '比利时胜方向清晰，不设置胜平负备选；若仍在第三名边缘，末轮必须主动提高射门量', handicap: '比利时-1附近，赢球方向清晰，穿盘取决于早段进球', order: '比利时胜 > 比利时必须提速 > 3-4球' },
  'panama-england-20260627': { result: '英格兰胜', resultBackup: '', score: '0-3', backup: '0-2', total: '2-3球', oneXtwo: '英格兰胜方向清晰，不设置胜平负备选；必发胜/平/负约82/12/6，成交量约24K，阵容厚度和定位球优势明显', handicap: '参考英格兰-1.5；英格兰赢球优先，深盘看轮换幅度', order: '英格兰胜 > 英格兰-1.5谨慎 > 2-3球' },
  'croatia-ghana-20260627': { result: '克罗地亚胜', resultBackup: '平局', score: '2-1', backup: '1-1', total: '2-3球', oneXtwo: '克罗地亚胜主选，平局低权重保护；必发胜/平/负约58/27/15，成交量约48K，克罗地亚控场更稳，加纳速度保留平局尾部', handicap: '参考克罗地亚-0.5；赢球优先，不追深盘', order: '克罗地亚胜 > 平局保护 > 2-3球' },
  'colombia-portugal-20260627': { result: '哥伦比亚胜', resultBackup: '平局', score: '2-1', backup: '1-1', total: '2-3球', oneXtwo: '哥伦比亚胜主选，平局作为葡萄牙控节奏保护；葡萄牙技术上限仍高，但若已提前占优，哥伦比亚对抗和战意制造小冷', handicap: '哥伦比亚受让方向优先，主胜是末轮战意大胆项', order: '哥伦比亚胜 > 平局保护 > 2-3球' },
  ...
  'algeria-austria-20260627': { result: '平局', resultBackup: '奥地利胜', score: '1-1', backup: '1-2', total: '2-3球', oneXtwo: '平局主选，奥地利胜低权重备选；必发胜/平/负约24/42/34，成交量约176K，平局赔率低位且成交放大，淘汰压力下更像谨慎拉锯', handicap: '参考奥地利0到-0.25谨慎；奥地利跑动体系完整，但阿尔及利亚反击会压住客胜权重', order: '平局 > 奥地利胜 > 2-3球' },
  ...
  'switzerland-canada-20260624': { result: '瑞士胜', resultBackup: '平局', score: '1-0', backup: '1-1', total: '1-2球', oneXtwo: '瑞士胜主选，平局重点保护；B组加拿大4分净胜+6、瑞士4分净胜+3，双方平局即可携手把前二主动权锁住，必发瑞士41/平31/加拿大28只给瑞士浅优势，低风险卡位比开放对攻更合理', handicap: '参考瑞士0到-0.25；瑞士胜面略高，但加拿大主场和速度反击会压住深让，赢球优先、不追穿盘', order: '瑞士胜 > 平局保护 > 1-2球' },
  'bosnia-qatar-20260624': { result: '波黑胜', resultBackup: '平局', score: '3-1', backup: '2-1', total: '3-4球', oneXtwo: '波黑胜主选，平局低权重保护；两队同为1分，波黑净胜-3优于卡塔尔-6，赢球到4分就能冲击B组前二或至少最佳第三，卡塔尔必须大胜，后程开放会抬高总进球', handicap: '参考波黑-0.25到-0.5；波黑高点和定位球更有直接得分路径，卡塔尔必须压出后，波黑反击和定位球二次进攻有放大比分空间', order: '波黑胜 > 波黑-0.25/-0.5 > 3-4球' },
  'scotland-brazil-20260624': { result: '巴西胜', resultBackup: '平局', score: '1-3', backup: '1-2', total: '3-4球', oneXtwo: '巴西胜主选，平局低权重保护；必发巴西约71%，巴西争头名仍有进攻动力，苏格兰3分净胜0不适合只守小负，若主动抢分会给巴西边路留下更大空间', handicap: '参考巴西-0.75到-1；巴西赢球面仍高，苏格兰定位球给一球空间，但比赛后段一旦拉开更接近3-4球', order: '巴西胜 > 巴西-0.75/-1 > 3-4球' },
  'morocco-haiti-20260624': { result: '摩洛哥胜', resultBackup: '', score: '3-0', backup: '2-0', total: '3-4球', oneXtwo: '摩洛哥胜方向清晰，不设置胜平负备选；摩洛哥4分面对0分海地，赢球可争C组头名，必发主胜约83%且主胜赔率走低，海地若为最后机会压出会放大失球风险', handicap: '参考摩洛哥-1到-1.25；摩洛哥胜面清晰，海地净胜球压力使比赛后段更容易断线，比分上限上调', order: '摩洛哥胜 > 摩洛哥-1/-1.25 > 3-4球' },
  'czechia-mexico-20260624': { result: '墨西哥胜', resultBackup: '平局', score: '0-1', backup: '1-1', total: '1-2球', oneXtwo: '墨西哥胜主选，平局重点保护；墨西哥6分已基本锁定A组第一，捷克1分净胜-1必须抢分但进攻效率有限，必发墨西哥约50%且客胜赔率上扬，比赛更像低比分消耗战', handicap: '参考墨西哥-0.25；墨西哥实力和主场仍占优，但已出线后的轮换使平局保护上调，捷克定位球是主要冷门入口', order: '墨西哥胜 > 平局保护 > 1-2球' },
...
const groupSituationNotes = {
  ...
  'switzerland-canada-20260624': '小组形势：加拿大4分净胜+6、瑞士4分净胜+3，平局基本可让双方携手锁住前二；若分出胜负，负方仍有4分，最佳第三也很稳，但会把同组波黑/卡塔尔胜者带入前二比较。',
  'bosnia-qatar-20260624': '小组形势：波黑和卡塔尔同积1分，波黑净胜-3、卡塔尔净胜-6。胜者到4分仍可争前二或最佳第三，平局到2分基本不够，因此波黑更有主动抢胜价值，卡塔尔需要更激进但净胜球包袱更重。',
  'scotland-brazil-20260624': '小组形势：巴西与摩洛哥同积4分，巴西保平大概率即可晋级；苏格兰3分净胜0，平局到4分几乎锁定最佳第三并有前二机会，即使小负也仍在第三名线附近，抢分动力强于普通受让方。',
  'morocco-haiti-20260624': '小组形势：摩洛哥4分净胜+1，海地0分净胜-4。摩洛哥赢球可争C组头名，平局也大概率晋级；海地只有大胜才可能进入第三名比较，必须冒险会放大身后空间。',
  'czechia-mexico-20260624': '小组形势：墨西哥6分净胜+3已基本锁定A组出线，末轮更可能控制消耗；捷克1分净胜-1，赢球可到4分冲前二或最佳第三，平局2分大概率不够，因此定位球和后段压上会更激进。',
  'southafrica-korea-20260624': '小组形势：韩国3分净胜0，赢球锁定前二，打平到4分也有较强最佳第三价值；南非1分净胜-2，必须赢球到4分才有现实出线窗口，若同时捷克抢分，本场会变成直接卡位战。',
...
const finishedReviewSource = [
  { id: "algeria-austria-20260627-server-review", matchId: "algeria-austria-20260627", homeTeam: "algeria", awayTeam: "austria", home: "阿尔及利亚", away: "奥地利", dateText: "6月28日 周日", kickoff: "10:00", group: "J组", venue: "Kansas City Stadium", endedAtSort: 202606281200, score: "3-3", resultMain: "平局", resultBackup: "奥地利胜", scoreMain: "1-1", scoreBackup: "1-2", totalPick: "2-3球", resultMainCorrect: true, resultBackupCorrect: false, scoreMainCorrect: false, scoreBackupCorrect: false, totalCorrect: false },
  { id: "jordan-argentina-20260627-server-review", matchId: "jordan-argentina-20260627", homeTeam: "jordan", awayTeam: "argentina", home: "约旦", away: "阿根廷", dateText: "6月28日 周日", kickoff: "10:00", group: "J组", venue: "Dallas Stadium", endedAtSort: 202606281200, score: "1-3", resultMain: "阿根廷胜", resultBackup: "", scoreMain: "0-4", scoreBackup: "1-4", totalPick: "4-5球", resultMainCorrect: true, resultBackupCorrect: false, scoreMainCorrect: false, scoreBackupCorrect: false, totalCorrect: true },
  { id: "colombia-portugal-20260627-server-review", matchId: "colombia-portugal-20260627", homeTeam: "colombia", awayTeam: "portugal", home: "哥伦比亚", away: "葡萄牙", dateText: "6月28日 周日", kickoff: "07:30", group: "K组", venue: "Miami Stadium", endedAtSort: 202606280930, score: "0-0", resultMain: "葡萄牙胜", resultBackup: "平局", scoreMain: "1-2", scoreBackup: "2-2", totalPick: "3-4球", resultMainCorrect: false, resultBackupCorrect: true, scoreMainCorrect: false, scoreBackupCorrect: false, totalCorrect: false },
  { id: "congodr-uzbekistan-20260627-server-review", matchId: "congodr-uzbekistan-20260627", homeTeam: "congoDr", awayTeam: "uzbekistan", home: "刚果民主共和国", away: "乌兹别克斯坦", dateText: "6月28日 周日", kickoff: "07:30", group: "K组", venue: "Atlanta Stadium", endedAtSort: 202606280930, score: "3-1", resultMain: "刚果民主共和国胜", resultBackup: "", scoreMain: "3-1", scoreBackup: "2-1", totalPick: "3-4球", resultMainCorrect: true, resultBackupCorrect: false, scoreMainCorrect: true, scoreBackupCorrect: false, totalCorrect: true },
  { id: "panama-england-20260627-server-review", matchId: "panama-england-20260627", homeTeam: "panama", awayTeam: "england", home: "巴拿马", away: "英格兰", dateText: "6月28日 周日", kickoff: "05:00", group: "L组", venue: "New York New Jersey Stadium", endedAtSort: 202606280700, score: "0-2", resultMain: "英格兰胜", resultBackup: "", scoreMain: "1-4", scoreBackup: "0-3", totalPick: "4-5球", resultMainCorrect: true, resultBackupCorrect: false, scoreMainCorrect: false, scoreBackupCorrect: false, totalCorrect: false },
  { id: "croatia-ghana-20260627-server-review", matchId: "croatia-ghana-20260627", homeTeam: "croatia", awayTeam: "ghana", home: "克罗地亚", away: "加纳", dateText: "6月28日 周日", kickoff: "05:00", group: "L组", venue: "Philadelphia Stadium", endedAtSort: 202606280700, score: "2-1", resultMain: "克罗地亚胜", resultBackup: "", scoreMain: "3-1", scoreBackup: "2-1", totalPick: "3-4球", resultMainCorrect: true, resultBackupCorrect: false, scoreMainCorrect: false, scoreBackupCorrect: true, totalCorrect: true },
  { id: "egypt-iran-20260626-server-review", matchId: "egypt-iran-20260626", homeTeam: "egypt", awayTeam: "iran", home: "埃及", away: "伊朗", dateText: "6月27日 周六", kickoff: "11:00", group: "G组", venue: "Seattle Stadium", endedAtSort: 202606271300, score: "1-1", resultMain: "平局", resultBackup: "伊朗胜", scoreMain: "1-1", scoreBackup: "0-1", totalPick: "1-2球", resultMainCorrect: true, resultBackupCorrect: false, scoreMainCorrect: true, scoreBackupCorrect: false, totalCorrect: true },
  { id: "newzealand-belgium-20260626-server-review", matchId: "newzealand-belgium-20260626", homeTeam: "newZealand", awayTeam: "belgium", home: "新西兰", away: "比利时", dateText: "6月27日 周六", kickoff: "11:00", group: "G组", venue: "BC Place Vancouver", endedAtSort: 202606271300, score: "1-5", resultMain: "比利时胜", resultBackup: "", scoreMain: "1-4", scoreBackup: "0-3", totalPick: "4-5球", resultMainCorrect: true, resultBackupCorrect: false, scoreMainCorrect: false, scoreBackupCorrect: false, totalCorrect: false },
  { id: "uruguay-spain-20260626-server-review", matchId: "uruguay-spain-20260626", homeTeam: "uruguay", awayTeam: "spain", home: "乌拉圭", away: "西班牙", dateText: "6月27日 周六", kickoff: "08:00", group: "H组", venue: "Estadio Guadalajara", endedAtSort: 202606271000, score: "0-1", resultMain: "乌拉圭胜", resultBackup: "平局", scoreMain: "2-1", scoreBackup: "1-1", totalPick: "2-3球", resultMainCorrect: false, resultBackupCorrect: false, scoreMainCorrect: false, scoreBackupCorrect: false, totalCorrect: false },
  { id: "caboverde-saudi-20260626-server-review", matchId: "caboverde-saudi-20260626", homeTeam: "caboVerde", awayTeam: "saudi", home: "佛得角", away: "沙特阿拉伯", dateText: "6月27日 周六", kickoff: "08:00", group: "H组", venue: "Houston Stadium", endedAtSort: 202606271000, score: "0-0", resultMain: "佛得角胜", resultBackup: "平局", scoreMain: "2-0", scoreBackup: "2-1", totalPick: "2-3球", resultMainCorrect: false, resultBackupCorrect: true, scoreMainCorrect: false, scoreBackupCorrect: false, totalCorrect: false },
  { id: "senegal-iraq-20260626-server-review", matchId: "senegal-iraq-20260626", homeTeam: "senegal", awayTeam: "iraq", home: "塞内加尔", away: "伊拉克", dateText: "6月27日 周六", kickoff: "03:00", group: "I组", venue: "Toronto Stadium", endedAtSort: 202606270500, score: "5-0", resultMain: "塞内加尔胜", resultBackup: "", scoreMain: "3-1", scoreBackup: "2-0", totalPick: "3-4球", resultMainCorrect: true, resultBackupCorrect: false, scoreMainCorrect: false, scoreBackupCorrect: false, totalCorrect: false },
  { id: "norway-france-20260626-server-review", matchId: "norway-france-20260626", homeTeam: "norway", awayTeam: "france", home: "挪威", away: "法国", dateText: "6月27日 周六", kickoff: "03:00", group: "I组", venue: "Boston Stadium", endedAtSort: 202606270500, score: "1-4", resultMain: "法国胜", resultBackup: "平局", scoreMain: "1-3", scoreBackup: "2-2", totalPick: "3-4球", resultMainCorrect: true, resultBackupCorrect: false, scoreMainCorrect: false, scoreBackupCorrect: false, totalCorrect: false },
  ...
  { id: "morocco-haiti-20260624-server-review", matchId: "morocco-haiti-20260624", homeTeam: "morocco", awayTeam: "haiti", home: "摩洛哥", away: "海地", dateText: "6月25日 周四", kickoff: "06:00", group: "C组", venue: "Atlanta Stadium", endedAtSort: 202606250800, score: "4-2", resultMain: "摩洛哥胜", resultBackup: "", scoreMain: "3-0", scoreBackup: "2-0", totalPick: "3-4球", resultMainCorrect: true, resultBackupCorrect: false, scoreMainCorrect: false, scoreBackupCorrect: false, totalCorrect: false },
  { id: "switzerland-canada-20260624-server-review", matchId: "switzerland-canada-20260624", homeTeam: "switzerland", awayTeam: "canada", home: "瑞士", away: "加拿大", dateText: "6月25日 周四", kickoff: "03:00", group: "B组", venue: "BC Place Vancouver", endedAtSort: 202606250500, score: "2-1", resultMain: "瑞士胜", resultBackup: "平局", scoreMain: "1-0", scoreBackup: "1-1", totalPick: "1-2球", resultMainCorrect: true, resultBackupCorrect: false, scoreMainCorrect: false, scoreBackupCorrect: false, totalCorrect: false },
  { id: "bosnia-qatar-20260624-server-review", matchId: "bosnia-qatar-20260624", homeTeam: "bosnia", awayTeam: "qatar", home: "波黑", away: "卡塔尔", dateText: "6月25日 周四", kickoff: "03:00", group: "B组", venue: "Seattle Stadium", endedAtSort: 202606250500, score: "3-1", resultMain: "波黑胜", resultBackup: "平局", scoreMain: "3-1", scoreBackup: "2-1", totalPick: "3-4球", resultMainCorrect: true, resultBackupCorrect: false, scoreMainCorrect: true, scoreBackupCorrect: false, totalCorrect: true },
  { id: "colombia-congodr-20260623-server-review", matchId: "colombia-congodr-20260623", homeTeam: "colombia", awayTeam: "congoDr", home: "哥伦比亚", away: "刚果民主共和国", dateText: "6月24日 周三", kickoff: "10:00", group: "K组", venue: "Estadio Guadalajara", endedAtSort: 202606241200, score: "1-0", resultMain: "哥伦比亚胜", resultBackup: "平局", scoreMain: "2-1", scoreBackup: "1-1", totalPick: "2-3球", resultMainCorrect: true, resultBackupCorrect: false, scoreMainCorrect: false, scoreBackupCorrect: false, totalCorrect: false },
  { id: "panama-croatia-20260623-server-review", matchId: "panama-croatia-20260623", homeTeam: "panama", awayTeam: "croatia", home: "巴拿马", away: "克罗地亚", dateText: "6月24日 周三", kickoff: "07:00", group: "L组", venue: "Toronto Stadium", endedAtSort: 202606240900, score: "0-1", resultMain: "克罗地亚胜", resultBackup: "", scoreMain: "0-2", scoreBackup: "1-2", totalPick: "2-3球", resultMainCorrect: true, resultBackupCorrect: false, scoreMainCorrect: false, scoreBackupCorrect: false, totalCorrect: false },
  { id: "england-ghana-20260623-server-review", matchId: "england-ghana-20260623", homeTeam: "england", awayTeam: "ghana", home: "英格兰", away: "加纳", dateText: "6月24日 周三", kickoff: "04:00", group: "L组", venue: "Boston Stadium", endedAtSort: 202606240600, score: "0-0", resultMain: "英格兰胜", resultBackup: "", scoreMain: "2-0", scoreBackup: "2-1", totalPick: "2-3球", resultMainCorrect: false, resultBackupCorrect: false, scoreMainCorrect: false, scoreBackupCorrect: false, totalCorrect: false },
  { id: "portugal-uzbekistan-20260623-server-review", matchId: "portugal-uzbekistan-20260623", homeTeam: "portugal", awayTeam: "uzbekistan", home: "葡萄牙", away: "乌兹别克斯坦", dateText: "6月24日 周三", kickoff: "01:00", group: "K组", venue: "Houston Stadium", endedAtSort: 202606240300, score: "5-0", resultMain: "葡萄牙胜", resultBackup: "", scoreMain: "3-0", scoreBackup: "2-0", totalPick: "2-3球", resultMainCorrect: true, resultBackupCorrect: false, scoreMainCorrect: false, scoreBackupCorrect: false, totalCorrect: false },
