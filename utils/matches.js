...
const predictionDiscipline = {
  ...
  'japan-sweden-20260625': { result: '日本胜', resultBackup: '平局', score: '2-1', backup: '1-1', total: '2-3球', oneXtwo: '日本胜主选，平局低权重保护；必发胜/平/负约51/27/22，成交量约175K，日本低赔位置稳定，瑞典更多依赖身体和定位球', handicap: '参考日本-0.25到-0.5；日本节奏和脚下优势更好，但瑞典高点使平局保护保留', order: '日本胜 > 平局保护 > 2-3球' },
  ...
  'norway-france-20260626': { result: '法国胜', resultBackup: '平局', score: '1-2', backup: '1-1', total: '2-3球', oneXtwo: '法国胜主选，平局低权重保护；必发胜/平/负约18/22/60，成交量约48K，法国定价占优但流动性刚起步', handicap: '参考法国-0.5；法国反击空间更好，挪威必须争胜会增加回合数，但客胜不追深盘', order: '法国胜 > 平局保护 > 2-3球' },
  ...
  'switzerland-canada-20260624': { result: '瑞士胜', resultBackup: '平局', score: '2-1', backup: '1-1', total: '2-3球', oneXtwo: '瑞士胜主选，平局重点保护；B组加拿大4分净胜+6、瑞士4分净胜+3，双方平局即可携手把前二主动权锁住，必发瑞士41/平31/加拿大28只给瑞士浅优势，瑞士结构更稳但不能排除默契低风险节奏', handicap: '参考瑞士0到-0.25；瑞士胜面略高，但加拿大主场和速度反击会压住深让，赢球优先、不追穿盘', order: '瑞士胜 > 平局保护 > 2-3球' },
  'bosnia-qatar-20260624': { result: '波黑胜', resultBackup: '平局', score: '2-1', backup: '1-1', total: '2-3球', oneXtwo: '波黑胜主选，平局低权重保护；两队同为1分，波黑净胜-3优于卡塔尔-6，赢球到4分就能冲击B组前二或至少最佳第三，卡塔尔必须大胜才有现实比较优势', handicap: '参考波黑-0.25；波黑高点和定位球更有直接得分路径，但后场速度不足，卡塔尔控球拖慢比赛会抬高平局尾部', order: '波黑胜 > 平局保护 > 2-3球' },
  'scotland-brazil-20260624': { result: '巴西胜', resultBackup: '平局', score: '1-2', backup: '1-1', total: '2-3球', oneXtwo: '巴西胜主选，平局低权重保护；必发巴西约71%，但巴西4分保平即可大概率前二，苏格兰3分净胜0已在最佳第三竞争中有价值，末轮不会只守输球', handicap: '参考巴西-0.75到-1；巴西赢球面仍高，但出线形势让比赛管理权重上升，苏格兰定位球和高球会限制深盘', order: '巴西胜 > 平局保护 > 2-3球' },
  'morocco-haiti-20260624': { result: '摩洛哥胜', resultBackup: '', score: '2-0', backup: '3-0', total: '2-3球', oneXtwo: '摩洛哥胜方向清晰，不设置胜平负备选；摩洛哥4分面对0分海地，赢球可争C组头名，必发主胜约83%且主胜赔率走低，出线动力和市场方向一致', handicap: '参考摩洛哥-1到-1.25；摩洛哥胜面清晰，但若同时段巴西领先，摩洛哥后段可能控风险，穿深盘看早段进球', order: '摩洛哥胜 > 摩洛哥-1谨慎 > 2-3球' },
  'czechia-mexico-20260624': { result: '墨西哥胜', resultBackup: '平局', score: '1-2', backup: '1-1', total: '2-3球', oneXtwo: '墨西哥胜主选，平局重点保护；墨西哥6分已基本锁定A组第一，捷克1分净胜-1必须抢分并盯韩国赛果，必发墨西哥约50%但客胜赔率上扬，轮换和比赛管理压低客胜权重', handicap: '参考墨西哥-0.25；墨西哥实力和主场仍占优，但已出线后的轮换使平局保护上调，捷克定位球是抢分入口', order: '墨西哥胜 > 平局保护 > 2-3球' },
  'southafrica-korea-20260624': { result: '韩国胜', resultBackup: '平局', score: '1-2', backup: '1-1', total: '2-3球', oneXtwo: '韩国胜主选，平局低权重保护；韩国3分净胜0，赢球即可锁住前二，打平也有最佳第三希望；南非1分净胜-2必须赢球才有出线比较价值，后程压上会给韩国反击空间', handicap: '参考韩国-0.25到-0.5；韩国转换速度和前场个人能力更稳定，但南非必须争胜，比赛后段波动会高于普通浅盘', order: '韩国胜 > 平局保护 > 2-3球' },
}
