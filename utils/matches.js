...
const betfairMarketSnapshot = {
  ...
  'portugal-uzbekistan-20260623': { marketId: '1.258056400', totalMatched: 472239, delayed: true, odds: { home: 1.18, draw: 8.8, away: 22 }, probability: { home: 84, draw: 11, away: 5 }, oddsMovement: { home: 'steam', draw: 'drift', away: 'drift' } },
  'england-ghana-20260623': { marketId: '1.257506605', totalMatched: 317106, delayed: true, odds: { home: 1.24, draw: 7.6, away: 17.5 }, probability: { home: 81, draw: 13, away: 6 }, oddsMovement: { home: 'steam', draw: 'drift', away: 'drift' } },
  'panama-croatia-20260623': { marketId: '1.257506750', totalMatched: 137755, delayed: true, odds: { home: 7.6, draw: 4.4, away: 1.55 }, probability: { home: 13, draw: 23, away: 64 }, oddsMovement: { home: 'drift', draw: 'drift', away: 'steam' } },
  'switzerland-canada-20260624': { marketId: '1.258370047', totalMatched: 120375, delayed: true, odds: { home: 2.48, draw: 3.2, away: 3.5 }, probability: { home: 40, draw: 31, away: 29 }, oddsMovement: { home: 'steam', away: 'drift' } },
  'scotland-brazil-20260624': { marketId: '1.258369771', totalMatched: 62351, delayed: true, odds: { home: 9.4, draw: 5.6, away: 1.4 }, probability: { home: 11, draw: 18, away: 72 }, oddsMovement: { home: 'drift', draw: 'drift', away: 'steam' } },
  'morocco-haiti-20260624': { marketId: '1.258422667', totalMatched: 59213, delayed: true, odds: { home: 1.21, draw: 7.8, away: 20 }, probability: { home: 82, draw: 13, away: 5 }, oddsMovement: { home: 'steam', draw: 'steam', away: 'drift' } },
  'czechia-mexico-20260624': { marketId: '1.258427197', totalMatched: 323217, delayed: true, odds: { home: 3.95, draw: 4.1, away: 2 }, probability: { home: 25, draw: 25, away: 50 }, oddsMovement: { home: 'steam', draw: 'steam', away: 'drift' } },
  'ecuador-germany-20260625': { marketId: '1.258423084', totalMatched: 212561, delayed: true, odds: { home: 4, draw: 4.2, away: 1.96 }, probability: { home: 25, draw: 24, away: 51 }, oddsMovement: { home: 'drift', away: 'steam' } },
  'japan-sweden-20260625': { marketId: '1.258426921', totalMatched: 131421, delayed: true, odds: { home: 1.97, draw: 3.65, away: 4.6 }, probability: { home: 51, draw: 27, away: 22 }, oddsMovement: { draw: 'drift' } },
  'tunisia-netherlands-20260625': { marketId: '1.258423448', totalMatched: 38132, delayed: true, odds: { home: 28, draw: 11, away: 1.14 }, probability: { home: 4, draw: 9, away: 87 }, oddsMovement: { home: 'drift', draw: 'drift', away: 'steam' } },
  'paraguay-australia-20260625': { marketId: '1.258369633', totalMatched: 298870, delayed: true, odds: { home: 3, draw: 2.32, away: 4.2 }, probability: { home: 33, draw: 43, away: 24 }, oddsMovement: { home: 'drift', draw: 'steam', away: 'drift' } },
  'caboverde-saudi-20260626': { marketId: '1.258424121', totalMatched: 113753, delayed: true, odds: { home: 2.48, draw: 3.55, away: 3.05 }, probability: { home: 40, draw: 28, away: 32 }, oddsMovement: { home: 'steam', draw: 'steam' } },
  'uruguay-spain-20260626': { marketId: '1.258423940', totalMatched: 34647, delayed: true, odds: { home: 8, draw: 4.4, away: 1.54 }, probability: { home: 13, draw: 23, away: 65 }, oddsMovement: { home: 'drift', draw: 'steam' } },
  'newzealand-belgium-20260626': { marketId: '1.258421820', totalMatched: 14845, delayed: true, odds: { home: 16, draw: 7.6, away: 1.24 }, probability: { home: 6, draw: 13, away: 81 }, oddsMovement: { draw: 'drift', away: 'steam' } },
  'egypt-iran-20260626': { marketId: '1.258433587', totalMatched: 49256, delayed: true, odds: { home: 2.52, draw: 2.76, away: 4.1 }, probability: { home: 40, draw: 36, away: 24 }, oddsMovement: { home: 'drift', draw: 'steam', away: 'drift' } },
  'norway-france-20260626': { marketId: '1.258423587', totalMatched: 27152, delayed: true, odds: { home: 4.9, draw: 4.4, away: 1.75 }, probability: { home: 20, draw: 23, away: 57 } },
  'senegal-iraq-20260626': { marketId: '1.258432503', totalMatched: 13772, delayed: true, odds: { home: 1.28, draw: 6.8, away: 13.5 }, probability: { home: 78, draw: 15, away: 7 } },
  'panama-england-20260627': { marketId: '1.258421971', totalMatched: 20736, delayed: true, odds: { home: 12.5, draw: 8, away: 1.25 }, probability: { home: 8, draw: 12, away: 80 } },
  'croatia-ghana-20260627': { marketId: '1.258424479', totalMatched: 27573, delayed: true, odds: { home: 1.72, draw: 3.75, away: 6.6 }, probability: { home: 58, draw: 27, away: 15 } },
  'colombia-portugal-20260627': { marketId: '1.258369909', totalMatched: 8653, delayed: true, odds: { home: 3.8, draw: 3.9, away: 2.08 }, probability: { home: 26, draw: 26, away: 48 } },
  'algeria-austria-20260627': { marketId: '1.258424618', totalMatched: 140629, delayed: true, odds: { home: 4.1, draw: 2.5, away: 2.84 }, probability: { home: 25, draw: 40, away: 35 } },
  'jordan-argentina-20260627': { marketId: '1.258424757', totalMatched: 46302, delayed: true, odds: { home: 17.5, draw: 7.6, away: 1.23 }, probability: { home: 6, draw: 13, away: 81 } }
}
