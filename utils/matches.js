...
const predictionDiscipline = {
  ...
  'switzerland-canada-20260624': { result: '瑞士胜', resultBackup: '平局', score: '2-1', backup: '1-1', total: '2-3球', oneXtwo: '瑞士胜主选，平局低权重保护；必发胜/平/负约41/31/28，成交量约150K，瑞士赔率小幅下压但三项仍接近，不能完全排除平局', handicap: '参考瑞士-0.25；瑞士结构更稳，加拿大速度有反击威胁，主胜优先但不追深盘', order: '瑞士胜 > 平局保护 > 2-3球' },
  'czechia-mexico-20260624': { result: '墨西哥胜', resultBackup: '平局', score: '1-2', backup: '1-1', total: '2-3球', oneXtwo: '墨西哥胜主选，平局低权重保护；必发胜/平/负约25/24/51，成交量约344K，墨西哥整体仍占优，但客胜赔率上扬到2.00，主胜权重不宜继续放大', handicap: '参考墨西哥-0.25到-0.5；墨西哥已锁定A组第一，轮换和比赛管理会压低大胜预期', order: '墨西哥胜 > 平局保护 > 2-3球' },
}
