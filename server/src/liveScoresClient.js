...
const KNOWN_MATCHES = [
  ...
  { id: 'turkey-paraguay-20260619', home: ['turkey', 'turkiye', 'türkiye'], away: ['paraguay'] },
  ...
  { id: 'panama-croatia-20260623', home: ['panama'], away: ['croatia'] },
  { id: 'england-ghana-20260623', home: ['england'], away: ['ghana'] },
  ...
  { id: 'southafrica-korea-20260624', home: ['south africa'], away: ['korea republic', 'south korea', 'korea'] },
  { id: 'czechia-mexico-20260624', home: ['czechia', 'czech republic'], away: ['mexico'] },
  { id: 'bosnia-qatar-20260624', home: ['bosnia', 'bosnia herzegovina', 'bosnia and herzegovina'], away: ['qatar'] },
  { id: 'switzerland-canada-20260624', home: ['switzerland'], away: ['canada'] },
  ...
  { id: 'norway-france-20260626', home: ['norway'], away: ['france'] },
  { id: 'senegal-iraq-20260626', home: ['senegal'], away: ['iraq'] },
  { id: 'caboverde-saudi-20260626', home: ['cabo verde', 'cape verde'], away: ['saudi arabia'] },
  { id: 'uruguay-spain-20260626', home: ['uruguay'], away: ['spain'] },
  { id: 'newzealand-belgium-20260626', home: ['new zealand'], away: ['belgium'] },
  { id: 'egypt-iran-20260626', home: ['egypt'], away: ['iran', 'ir iran'] },
  { id: 'panama-england-20260627', home: ['panama'], away: ['england'] },
  { id: 'croatia-ghana-20260627', home: ['croatia'], away: ['ghana'] },
...
function formatChinaSchedule(isoDate) {
  ...
  return {
    dateText: `${getPart('month')}月${getPart('day')}日 ${getPart('weekday')}`,
...
async function fetchLiveScores(matchIds = []) {
  const matches = {}
  ...
  return matchIds.length ? matchIds.reduce((result, id) => {
    if (matches[id]) result[id] = matches[id]
    return result
  }, {}) : matches
}
